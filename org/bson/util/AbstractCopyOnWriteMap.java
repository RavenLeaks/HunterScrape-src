...
implements ConcurrentMap<K, V> {
    ...
    public final void clear() {
        this.lock.lock();
        try {
            this.set(this.copy(Collections.<K, V>emptyMap()));
        }
        finally {
            this.lock.unlock();
        }
    ...
    final class Mutable
    extends View<K, V> {
        private final transient AbstractCopyOnWriteMap<K, V, M> keySet;
        private final transient AbstractCopyOnWriteMap<K, V, M> entrySet;
        private final transient AbstractCopyOnWriteMap<K, V, M> values;
