...
extends BsonWriterSettings {
    ...
    public JsonWriterSettings() {
        this(JsonWriterSettings.builder().outputMode(JsonMode.STRICT));
    }

    @Deprecated
    public JsonWriterSettings(JsonMode outputMode) {
        this(JsonWriterSettings.builder().outputMode(outputMode));
    }

    @Deprecated
    public JsonWriterSettings(boolean indent) {
        this(JsonWriterSettings.builder().indent(indent));
    }

    @Deprecated
    public JsonWriterSettings(JsonMode outputMode, boolean indent) {
        this(JsonWriterSettings.builder().outputMode(outputMode).indent(indent));
    }

    @Deprecated
    public JsonWriterSettings(JsonMode outputMode, String indentCharacters) {
        this(JsonWriterSettings.builder().outputMode(outputMode).indent(true).indentCharacters(indentCharacters));
    }

    @Deprecated
    public JsonWriterSettings(JsonMode outputMode, String indentCharacters, String newLineCharacters) {
        this(JsonWriterSettings.builder().outputMode(outputMode).indent(true).indentCharacters(indentCharacters).newLineCharacters(newLineCharacters));
    }
